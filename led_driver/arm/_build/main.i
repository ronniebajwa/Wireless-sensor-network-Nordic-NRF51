...
#line 225 "..\\..\\..\\..\\..\\Include\\s110\\ble_gap.h"
...
#line 245 "..\\..\\..\\..\\..\\Include\\s110\\ble_gap.h"
...
typedef enum
{
    BLE_LSS_EVT_NOTIFICATION_ENABLED,  
    BLE_LSS_EVT_NOTIFICATION_DISABLED  
} ble_lss_evt_type_t;

 
typedef struct
{
    ble_lss_evt_type_t evt_type;  
} ble_lss_evt_t;
...
typedef struct
{
    ble_lss_evt_handler_t        evt_handler;  
    ble_srv_cccd_security_mode_t lss_attr_md;  
    ble_device_params_t          dev_params;   
} ble_lss_init_t;
...
typedef struct ble_lss_s
{
    ...
    ble_gatts_char_handles_t lss_ls_handle;   
    ble_gatts_char_handles_t lss_ai_handle;   
    ble_device_params_t      dev_params;      
    uint16_t                 conn_handle;     
} ble_lss_t;
...
static app_timer_id_t m_update_timer_id;                          
static _Bool           m_memory_access_in_progress = 0;        
static ble_lss_t      m_lss;                                      
...
{
    do { app_error_handler((nrf_error), 101, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void update_advertising_packet(uint8_t state)
{
    ...
    service_data[0].service_uuid = 0x1866; 
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 144, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((3)) * 40) + ( 3 * (8 + (((5) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (3), (5) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 181, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    
    err_code = app_timer_create(&m_update_timer_id,
                                APP_TIMER_MODE_REPEATED,
                                adv_packet_update_timeout_handler);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 187, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_device_name_set(&sec_mode, (const uint8_t *)"LED_Driver", strlen("LED_Driver"));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 205, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = sd_ble_gap_appearance_set(384);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 218, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    uint8_t                    led_init_state = (uint8_t)LED_RED;
    ble_advdata_service_data_t service_data[1];
...
static void services_init(void)
{
    ...
    do {(&lss_init . lss_attr_md . cccd_write_perm)->sm = 1; (&lss_init . lss_attr_md . cccd_write_perm)->lv = 1;} while(0);
    do {(&lss_init . lss_attr_md . read_perm)->sm = 1; (&lss_init . lss_attr_md . read_perm)->lv = 1;} while(0);
    do {(&lss_init . lss_attr_md . write_perm)->sm = 1; (&lss_init . lss_attr_md . write_perm)->lv = 1;} while(0);
...
static void device_manager_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 315, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = dm_init(&init_data);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 318, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void application_timers_start(void)
{
    ...
    err_code = app_timer_start(m_update_timer_id, ((uint32_t)((((2000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0);
...
void advertising_start(uint16_t adv_interval)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 383, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void system_off_mode_enter(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 397, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

...
uint32_t ble_lss_init(ble_lss_t * p_lss, const ble_lss_init_t * p_lss_init)
{
    ...
    p_lss->conn_handle             = 0xFFFF;
    p_lss->dev_params.adv_interval = 100;
    p_lss->dev_params.state        = LED_RED;

    
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x1866;} while(0);
...
static void save_adv_interval(ble_lss_t * p_lss, const uint8_t * data)
{
    ...
    {
        if(interval < 0x0020) interval = 0x0020;
        else interval = 0x4000;
...
static uint32_t led_state_char_add(ble_lss_t * p_lss, const ble_lss_init_t * p_lss_init)
{
    ...
    uint8_t             char_init_val = (uint8_t)LED_RED;
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A57;} while(0);
...
static uint32_t adv_params_char_add(ble_lss_t * p_lss, const ble_lss_init_t * p_lss_init)
{
    ...
    do { ble_uuid . type = 0x01; ble_uuid . uuid = 0x2A58;} while(0);

...
#line 39 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 54 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 69 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 84 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 99 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 114 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 129 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 144 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 159 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 174 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"

#line 189 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"
...
#line 209 "C:\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\inttypes.h"
...
_Bool m_memory_access_in_progress = 0;  
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 61, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void button_event_handler(uint8_t pin_no, uint8_t button_action)
{
    if (button_action == 1)
    {
        switch (pin_no)
        {
            ...
            default:
                do { app_error_handler((pin_no), 80, (uint8_t*) "..\\main.c"); } while (0);
                break;
        }
    }
}
...
static void buttons_init(void)
{
    ...
    do { uint32_t ERR_CODE = app_button_init((buttons), (sizeof (buttons) / sizeof (buttons[0])), (((uint32_t)((((50) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)))), (0) ? app_button_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 100, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    err_code = app_button_enable();
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 103, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((2)) * 40) + ( 3 * (8 + (((5) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (2), (5) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 114, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
{
    do { static uint32_t APP_SCHED_BUF[((((((((0)) + 8) * (((5)) + 1))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_sched_init((0), (5), APP_SCHED_BUF); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 276, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void device_manager_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 293, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 314, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}

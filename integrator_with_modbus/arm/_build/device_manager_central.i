#line 1 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 16 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 17 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 18 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 19 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 20 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 44 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 117 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 141 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 167 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 207 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"




 
#line 220 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 235 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
#line 250 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"




 
#line 264 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"




 
#line 287 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
{
    return ((m_peer_addr_update & (m_bit_set << index))? 1: 0);
}
                                                      ...
                                                      ble_gap_addr_t * p_addr)
{
    ...
    for (index = 0; index < 7; index++)
    {
        ...
        ;
#line 631 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
static __inline api_result_t device_instance_free(uint32_t device_index)
{
    ...
    if (retval == ((0x0) + 0))
    {
        ...
        retval = pstorage_clear(&block_handle, (((sizeof(peer_id_t))+(sizeof(bond_context_t))) + ((sizeof(dm_gatts_context_t))+(sizeof(dm_gatt_client_context_t))) + (sizeof(uint32_t) + 20)));
        if (retval == ((0x0) + 0))
        {
...
static api_result_t device_instance_find(ble_gap_addr_t * p_addr, uint32_t * p_device_index)
{
    ...
    for (index = 0; index < 7; index++)
    {
        ...
        ;
#line 705 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
...
static __inline uint32_t connection_instance_alloc(uint32_t * instance)
{
    ...
    retval = connection_instance_find(0xFFFF, 0x01, instance);
    if (retval == ((0x0) + 0))
    {
        ;
        m_connection_table[*instance].state = 0x02;
    }
    else
    {
        ;
...
static __inline void connection_instance_free(uint32_t * instance)
{
    ...
    if (m_connection_table[*instance].state != 0x01)
    {
        ;
...
static __inline void device_context_store(dm_handle_t const * p_handle, device_store_state_t state)
{
    ...
    if (retval == ((0x0) + 0))
    {
        ...
        if ((retval == ((0x0) + 0)) && (state != UPDATE_PEER_ADDR))
        {
            m_connection_table[p_handle->connection_id].state &= (~0x40);
                                                ...
                                                dm_handle_t const       * p_handle)
{
    ...
    if (retval == ((0x0) + 0))
    {
        ...
        ;
        if (m_gatts_table[p_handle->connection_id].size == 0xFFFF)
        {
                                   ...
                                   uint32_t            data_len)
{
    ...
    ((void)(dm_handle_initialize(&dm_handle)));
    dm_handle.appl_id = 0;
    ...
    if (dm_handle.device_id != 0xFF)
    {
        ...
        else
        {
            ...
            if (index_count < 7)
            {
                ...
                if ((result == ((0x0) + 0)) &&
                    (0 == update_status_bit_is_set(dm_handle.device_id)))
                {
                    app_notify = 0;
                }
                else
            ...
            else
            {
                ...
                else
                {
                    index_count =
                        ((uint32_t)(p_data -
                                    (uint8_t *)m_gatts_table)) / (sizeof(dm_gatts_context_t));
                    ...
                    if (index_count < 1)
                    {
                        ...
                        if ((m_connection_table[index_count].state & 0x02) != 0x02)
                        {
                            ;
                    ...
                    else
                    {
                        ...
                        else if (m_app_context_table[dm_handle.device_id] == p_data)
                        {
                            ...
                            for (uint32_t c_index = 0; c_index < 1;
                                 c_index++)
                            {
            ...
            for (index = 0; index < 7; index++)
            {
                ...
                if (retval == ((0x0) + 0))
                {
                    ...
                    else
                    {
                        ...
                        ;
#line 1428 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
                    }
    ...
    if ((m_connection_table[p_handle->connection_id].state & 0x02) == 0x02)
    {
        ...
        else
        {
            ...
            if (retval == ((0x0) + 0))
            {
                ...
                if ((m_application_table[p_handle->appl_id].state & 0x01)
                    == 0x01)
                {
                    ;
                    m_connection_table[p_handle->connection_id].state |= 0x20;
                    m_application_table[p_handle->appl_id].state      |= 0x02;
                    retval = ((0x0) + 0);
                }
                else
                {
                                    ...
                                    dm_service_context_t const * p_context)
{
    ...
    if ((p_context->context_data.p_data != 0) && (p_context->context_data.len != 0) &&
                                        ...
                                        dm_application_context_t const * p_context)
{
    ...
    if (retval == ((0x0) + 0))
    {
        ...
        if ((retval == ((0x0) + 0)) && (context_len != 0xFFFFFFFF))
        {
                              ...
                              ble_gap_addr_t    * p_addr)
{
    ...
    {
        if ((p_handle->connection_id != 0xFF) &&
            ((m_connection_table[p_handle->connection_id].state & 0x02) == 0x02))
        {
            ;
...
void dm_ble_evt_handler(ble_evt_t * p_ble_evt)
{
    ...
    ((void)(dm_handle_initialize(&handle)));
    ...
    {
        retval = connection_instance_find(p_ble_evt->evt.gap_evt.conn_handle, 0x02, &index);
        if (retval == ((0x0) + 0))
        {
        ...
        case BLE_GAP_EVT_CONNECTED:
            ...
            if (retval == ((0x0) + 0))
            {
                ...
                if (((0x0) + 0) == retval)
                {
                    ...
                    {
                        ;
#line 2287 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\experimental\\device_manager_central.c"
    ...
    {
        if ((m_application_table[0].state & 0x02) == 0x02)
        {
            dm_handle_t pending_handle;
            uint32_t    pending_index;

            ;
            retval = connection_instance_find(0xFFFF,
                                              0x20,
                                              &pending_index);
            if (retval == ((0x0) + 0))
            {

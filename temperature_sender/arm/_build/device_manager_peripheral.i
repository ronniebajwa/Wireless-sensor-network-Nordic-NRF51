...
#line 33 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 109 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 135 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 168 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 212 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"



 
#line 224 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 242 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 258 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 276 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
...
#line 302 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
                                   ...
                                   uint32_t            data_len)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1212, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"); } while (0); } } while (0);
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        app_notify        = 0;
                        dm_event.event_id = 0x40;
#line 1367 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
                    }
                }
            }
        }
            ...
            for (index = 0; index < 7; index++)
            {
                ...
                if (err_code == ((0x0) + 0))
                {
                    ...
                    else
                    {
                        ...
                        ;
#line 1488 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
                    }
                }
                else
                {
...
api_result_t dm_application_context_set(dm_handle_t const              * p_handle,
                                        dm_application_context_t const * p_context)
{
#line 1910 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
    return ((((0x0) + 0x0080)+0x0011) | (0x8000));
...
api_result_t dm_application_context_get(dm_handle_t const        * p_handle,
                                        dm_application_context_t * p_context)
{
#line 1978 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
    return ((((0x0) + 0x0080)+0x0011) | (0x8000));
...
{
#line 2034 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"
    return ((((0x0) + 0x0080)+0x0011) | (0x8000));
...
void dm_ble_evt_handler(ble_evt_t * p_ble_evt)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 2291, (uint8_t*) "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"); } while (0); } } while (0);
        ...
        case BLE_GAP_EVT_CONNECTED:
            ...
            if (err_code == ((0x0) + 0))
            {
                ...
                if (err_code == ((0x0) + 0))
                {
                    ...
                    {
                        ;
#line 2370 "..\\..\\..\\..\\..\\Source\\ble\\device_manager\\device_manager_peripheral.c"

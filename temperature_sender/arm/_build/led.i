...
static void ppi_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 70, (uint8_t*) "..\\led.c"); } while (0); } } while (0);

    
    err_code = sd_ppi_channel_enable_set((0x1UL << (0UL)));
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 74, (uint8_t*) "..\\led.c"); } while (0); } } while (0);
}
